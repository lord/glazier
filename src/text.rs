...
//! 4. If `key_down` returned `false`, glazier forwards the key event to the
...
//! ## Supported Platforms
//!
//! Currently, `glazier` text input is fully implemented on macOS. Our goal
//! is to have full support for all glazier targets, but for now,
